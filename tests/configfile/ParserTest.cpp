...
//files configfile_double_brackets, configfile_empty, configfile_misplaced_semicolon, 
//configfile_missing_semicolon, configfile_only_qoutes, configfile_to_many_closing_brackets 
//configfile_unclosed_bracket, configfile_wrong_brackets, cofigfile_wrong_command

//compare error message code
/* 	testing::internal::CaptureStderr();
	instance.loadConfigFile(configFileName);
	std::string output = testing::internal::GetCapturedStderr();
	ASSERT_EQ(output, "Error: Configuration file (line 1): Unexpected semicolon found\n"); */
