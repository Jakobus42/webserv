 ...
 */
int ConfigFileParser::server(std::vector<std::string>& args, int& lineCount,
							 int layer) {
	(void)layer;
	if (args.size() != 1) {
 ...
 * @return int 0 if successful, 1 if not.
 */
int ConfigFileParser::listen(std::vector<std::string>& args, int& lineCount,
							 int layer) {
	(void)layer;
	if (args.size() != 2) {
		LOG("Configuration file (line "
 ...
 * @return int 0 if successful, 1 if not.
 */
int ConfigFileParser::serverName(std::vector<std::string>& args, int& lineCount,
								 int layer) {
	(void)layer;
	if (args.size() < 2) {
		LOG("Configuration file (line "
 ...
 * @return int 0 if successful, 1 if not.
 */
int ConfigFileParser::errorPage(std::vector<std::string>& args, int& lineCount,
								int layer) {
	(void)layer;
 ...
 * @return int 0 if successful, 1 if not.
 */
int ConfigFileParser::root(std::vector<std::string>& args, int& lineCount,
						   int layer) {
	(void)layer;
	if (args.size() != 2) {
		LOG("Configuration file (line "
 ...
 * @return int 0 if successful, 1 if not.
 */
int ConfigFileParser::autoindex(std::vector<std::string>& args, int& lineCount,
								int layer) {
	(void)layer;
	if (args.size() != 2) {
		LOG("Configuration file (line "
 ...
 * @return int 0 if successful, 1 if not.
 */
int ConfigFileParser::index(std::vector<std::string>& args, int& lineCount,
							int layer) {
	(void)layer;
